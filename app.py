...
API_KEY = os.environ.get("GEMINI_API_KEY", "AIzaSyCumvEFBY7U5thz9vpGxaggdOdD_-FhaMg")
...
def chat():
    ...
    if not data:
        return jsonify({"reply": "I couldn't read your message, Meri bawli."}), 400
    ...
    try:
        ...
        history.pop()
        return jsonify({"reply": "The cloud is slow today. Try again in a moment."}), 504
